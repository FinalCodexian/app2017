...
<head>
  ...
  <style>
  header { position: fixed; top: 0px; left: 0px; right: 0px; height: 50px; font-size: 11px; line-height: 14px}
  ...
  footer { position: fixed; bottom: -60px; left: 0px; right: 0px; height: 50px; text-align: center; border-top: 1px solid #000;
    ...
    * { font-family: "Calibri", sans-serif; font-size: 10px}
    ...
    table#tbReporte { width: 100% !important; margin: 0 auto; border-collapse: collapse;}
    ...
    <body>
      <header>
        <table>
          <tr>
            <td>J. CH. COMERCIAL S. A.</td>
          </tr>
          <tr>
            <td width='500px'>REPORTE DE VENTAS N&deg; RV-JCH-039-080218</td>
            <td>Fecha: jueves, 27 de febrero del 2018</td>
          </tr>
          <tr>
            <td>AGENCIA: 9100 - LIM CANADA 256</td>
            <td>T/C COMPRA: 3.220      T/C VENTA: 3.260</td>
          </tr>
        </table>
      </header>
